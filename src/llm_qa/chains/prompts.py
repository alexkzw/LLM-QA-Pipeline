...
REFINEMENT_PROMPT = PromptTemplate(
    ...
    template=(
        ...
        "3. The reader of the revised answer will NOT see this fact-check or "
        "the original answer - do not leave any transitional or comparative "
        "language that only makes sense next to a removed claim (e.g. "
        "'under a different scenario', 'unlike the previous point', 'in "
        "contrast'). The revised answer must read as a complete, standalone "
        "answer on its own.\n\n"
        "Reference:\n{reference}\n\nCurrent answer:\n{response}\n\n"
        "Revised answer:"
    ),
